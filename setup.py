...
try:
    ...
    raise ImportError("install sip first (comming with PyQt4 or 5)")
...
try:
    ...
    try:
        ...
        try:
            ...
            raise ImportError("neither PyQt4, PyQt5 or Pyside found, you need to install it to run pandas-qt")
