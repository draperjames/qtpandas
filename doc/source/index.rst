.. qtpandas documentation master file, created by
...
:Repository: `GitHub <https://github.com/datalyze-solutions/qtpandas>`_
:Version: |version|
...
Download the source from git ``git clone https://github.com/datalyze-solutions/qtpandas`` or as zip.
...
A very simple example::  
    ...
    """set the sip version, cause qtpandas uses version 2 by default"""
    import sip
    ...
    qtpandas.setDelegatesFromDtype(widget)
